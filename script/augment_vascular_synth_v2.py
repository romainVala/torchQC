...
dirout = '/network/iss/cenir/analyse/irm/users/romain.valabregue/PVsynth/training_saved_sample/Ulra3suj_SkVessel/'
...
if TEST:
    ...
    dataset_name, dnnunet_root = 'Dataset708_Ultra_SkulVasc40', '/network/iss/cenir/analyse/irm/users/romain.valabregue/PVsynth/training_saved_sample/nnunet/'
