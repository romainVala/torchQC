from segmentation.metrics.utils import mean_metric, all_metric
...
class Dice:
    ...
    def all_dice_loss(self, prediction, target):
        return all_metric(prediction, target, self.dice_loss)
